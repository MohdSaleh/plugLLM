...
| --- | --- | --- |
| `vn.get_` | Fetch some data | [`vn.get_related_ddl(...)`][vanna.base.base.PlugBase.get_related_ddl] |
| `vn.add_` | Adds something to the retrieval layer | [`vn.add_question_sql(...)`][vanna.base.base.PlugBase.add_question_sql] <br> [`vn.add_ddl(...)`][vanna.base.base.PlugBase.add_ddl] |
| `vn.generate_` | Generates something using AI based on the information in the model | [`vn.generate_sql(...)`][vanna.base.base.PlugBase.generate_sql] <br> [`vn.generate_explanation()`][vanna.base.base.PlugBase.generate_explanation] |
| `vn.run_` | Runs code (SQL) | [`vn.run_sql`][vanna.base.base.PlugBase.run_sql] |
| `vn.remove_` | Removes something from the retrieval layer | [`vn.remove_training_data`][vanna.base.base.PlugBase.remove_training_data] |
| `vn.connect_` | Connects to a database | [`vn.connect_to_snowflake(...)`][vanna.base.base.PlugBase.connect_to_snowflake] |
...
class PlugBase(ABC):
    ...
    def generate_sql(self, question: str, **kwargs) -> str:
        ...
        - [`get_similar_question_sql`][vanna.base.base.PlugBase.get_similar_question_sql]

        - [`get_related_ddl`][vanna.base.base.PlugBase.get_related_ddl]

        - [`get_related_documentation`][vanna.base.base.PlugBase.get_related_documentation]

        - [`get_sql_prompt`][vanna.base.base.PlugBase.get_sql_prompt]

        - [`submit_prompt`][vanna.base.base.PlugBase.submit_prompt]
    ...
    def connect_to_sqlite(self, url: str):
        """
        Connect to a SQLite database. This is just a helper function to set [`vn.run_sql`][vanna.base.base.PlugBase.run_sql]
    ...
    def connect_to_postgres(
        ...
        """
        Connect to postgres using the psycopg2 connector. This is just a helper function to set [`vn.run_sql`][vanna.base.base.PlugBase.run_sql]
        **Example:**
        ```python
    ...
    def connect_to_bigquery(self, cred_file_path: str = None, project_id: str = None):
        """
        Connect to gcs using the bigquery connector. This is just a helper function to set [`vn.run_sql`][vanna.base.base.PlugBase.run_sql]
        **Example:**
        ```python
    ...
    def connect_to_duckdb(self, url: str, init_sql: str = None):
        """
        Connect to a DuckDB database. This is just a helper function to set [`vn.run_sql`][vanna.base.base.PlugBase.run_sql]
    ...
    #     """
    #     Connect to a Microsoft SQL Server database. This is just a helper function to set [`vn.run_sql`][vanna.base.base.PlugBase.run_sql]
    ...
    def train(
        ...
        **Example:**
        ...
        If you call it with the sql argument, it's equivalent to [`vn.add_question_sql()`][vanna.base.base.PlugBase.add_question_sql].
        If you call it with the ddl argument, it's equivalent to [`vn.add_ddl()`][vanna.base.base.PlugBase.add_ddl].
        If you call it with the documentation argument, it's equivalent to [`vn.add_documentation()`][vanna.base.base.PlugBase.add_documentation].
        Additionally, you can pass a [`TrainingPlan`][vanna.types.TrainingPlan] object. Get a training plan with [`vn.get_training_plan_generic()`][vanna.base.base.PlugBase.get_training_plan_generic].
